...
export const line = (pointA: [number, number], pointB: [number, number]) => {
...
export const controlPoint = (lineCalc: Function, smooth: number) => (current: [number, number], previous: [number, number], next: [number, number], reverse: boolean | undefined) => {
...
export const bezierCommand = (controlPointCalc: Function) => (point: [number, number], i: number, a: [number, number][]) => {
    // start control point
...
export const svgPath = (points: [number, number][], command: Function) => {
